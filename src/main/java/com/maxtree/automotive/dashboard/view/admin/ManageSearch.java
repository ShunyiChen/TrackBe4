...
public class ManageSearch extends HorizontalLayout {
	 ...
	 * @param mainView
	 */
	public ManageSearch(AdminMainView mainView) {
		setMargin(false);
	    setSpacing(false);
	    setWidth("678px");
		...
		Label parentTitle = new Label("查询授权");
		...
		// 站点标题
		Label gridTitle = new Label("用户授权");
		gridTitle.addStyleName("grid-title");
		// 表格
		ManageSearchGrid grid = new ManageSearchGrid();
