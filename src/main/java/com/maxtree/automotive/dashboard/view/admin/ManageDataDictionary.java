...
public class ManageDataDictionary extends HorizontalLayout {
	 ...
	 * @param mainView
	 */
	public ManageDataDictionary(AdminMainView mainView) {
		setMargin(false);
	    setSpacing(false);
	    setWidth("678px");
		...
		Label parentTitle = new Label("管理数据字典");
		...
		// 站点标题
		Label gridTitle = new Label("数据字典");
		gridTitle.addStyleName("grid-title");
		// 表格
		ManageDataDictionaryGrid grid = new ManageDataDictionaryGrid();
