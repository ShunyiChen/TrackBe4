...
public class ManageCompany extends HorizontalLayout {
	 ...
	 * @param mainView
	 */
	public ManageCompany(AdminMainView mainView) {
		setMargin(false);
	    setSpacing(false);
	    setWidth("678px");
		...
		Label parentTitle = new Label("管理机构");
		...
		// 站点标题
		Label gridTitle = new Label("机构");
		gridTitle.addStyleName("grid-title");
		// 表格
		ManageCompanyGrid grid = new ManageCompanyGrid();
