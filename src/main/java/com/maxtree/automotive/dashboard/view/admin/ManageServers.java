...
public class ManageServers extends HorizontalLayout {
	 ...
	 * @param mainView
	 */
	public ManageServers(AdminMainView mainView) {
		setMargin(false);
	    setSpacing(false);
	    setWidth("678px");
		...
		Label parentTitle = new Label("管理服务器");
		...
		// 服务器标题
		Label gridTitle = new Label("服务器");
		gridTitle.addStyleName("grid-title");
		// 表格
		ManageSitesGrid grid = new ManageSitesGrid();
