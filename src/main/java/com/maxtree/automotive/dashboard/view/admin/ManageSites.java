...
public class ManageSites extends HorizontalLayout {
	 ...
	 * @param mainView
	 */
	public ManageSites(AdminMainView mainView) {
		setMargin(false);
	    setSpacing(false);
	    setWidth("678px");
		...
		Label parentTitle = new Label("管理站点");
