...
public class ManageRoles extends HorizontalLayout {
	 ...
	 * @param mainView
	 */
	public ManageRoles(AdminMainView mainView) {
		setMargin(false);
	    setSpacing(false);
	    setWidth("678px");
		...
		Label parentTitle = new Label("管理角色");
		...
		// 站点标题
		Label gridTitle = new Label("角色");
		gridTitle.addStyleName("grid-title");
		// 表格
		ManageRolesGrid grid = new ManageRolesGrid();
