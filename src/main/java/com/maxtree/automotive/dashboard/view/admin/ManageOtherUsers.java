...
public class ManageOtherUsers extends VerticalLayout {
	...
	public ManageOtherUsers(AdminMainView mainView) {
		setMargin(false);
	    setSpacing(false);
	    setWidth("678px");
		...
		Label parentTitle = new Label("管理其他用户");
		...
		Label gridTitle = new Label("其他用户");
		gridTitle.addStyleName("grid-title");
		// 表格
		ManageOtherUsersGrid grid = new ManageOtherUsersGrid();
