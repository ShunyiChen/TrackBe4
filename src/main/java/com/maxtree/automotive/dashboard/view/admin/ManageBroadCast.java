...
public class ManageBroadCast extends VerticalLayout {
	 ...
	 * @param mainView
	 */
	public ManageBroadCast(AdminMainView mainView) {
		setMargin(false);
	    setSpacing(false);
	    setWidth("678px");
		...
		Label parentTitle = new Label("广播消息");
		...
		// 业务类型标题
		Label gridTitle = new Label("广播消息");
		gridTitle.addStyleName("grid-title");
		// 表格
		ManageBroadCastGrid grid = new ManageBroadCastGrid();
