...
public class ManageTenants extends HorizontalLayout {
	 ...
	 * @param mainView
	 */
	public ManageTenants(AdminMainView mainView) {
		setMargin(false);
	    setSpacing(false);
	    setWidth("678px");
		...
		Label parentTitle = new Label("管理租户");
		...
		// 站点标题
		Label gridTitle = new Label("租户");
		gridTitle.addStyleName("grid-title");
		// 表格
		ManageTenantsGrid grid = new ManageTenantsGrid();
