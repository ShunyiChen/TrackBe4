...
public class ManageStorehouse extends HorizontalLayout {
	 ...
	 * @param mainView
	 */
	public ManageStorehouse(AdminMainView mainView) {
		setMargin(false);
	    setSpacing(false);
	    setWidth("678px");
		...
		Label parentTitle = new Label("管理库房");
		...
		// 站点标题
		Label gridTitle = new Label("库房");
		gridTitle.addStyleName("grid-title");
		// 表格
		ManageStorehouseGrid grid = new ManageStorehouseGrid();
