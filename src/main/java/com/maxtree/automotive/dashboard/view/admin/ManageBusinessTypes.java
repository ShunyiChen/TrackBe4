...
public class ManageBusinessTypes extends VerticalLayout {
	 ...
	 * @param mainView
	 */
	public ManageBusinessTypes(AdminMainView mainView) {
		setMargin(false);
	    setSpacing(false);
	    setWidth("678px");
		...
		Label parentTitle = new Label("管理业务类型");
		...
		// 表格
		ManageBusinessTypesGrid grid = new ManageBusinessTypesGrid();
