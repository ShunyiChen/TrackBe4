...
public class ManageCommunityInvitations extends HorizontalLayout {
	 ...
	 * @param mainView
	 */
	public ManageCommunityInvitations(AdminMainView mainView) {
		setMargin(false);
	    setSpacing(false);
	    setWidth("678px");
		...
		Label parentTitle = new Label("社区邀请");
		...
		// 站点标题
		Label gridTitle = new Label("社区");
		gridTitle.addStyleName("grid-title");
		// 表格
//		ManageCommunityGrid grid = new ManageCommunityGrid();
