...
public class ManagePermissions extends HorizontalLayout {
	 ...
	 * @param mainView
	 */
	public ManagePermissions(AdminMainView mainView) {
		setMargin(false);
	    setSpacing(false);
	    setWidth("678px");
		...
		Label parentTitle = new Label("管理权限");
		...
		// 站点标题
		Label gridTitle = new Label("权限");
		gridTitle.addStyleName("grid-title");
		// 表格
		ManagePermissionsGrid grid = new ManagePermissionsGrid();
