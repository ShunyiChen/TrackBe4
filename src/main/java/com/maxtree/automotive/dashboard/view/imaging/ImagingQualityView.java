...
public class ImagingQualityView extends Panel implements View, FrontendViewIF{
	...
	private static final Logger log = LoggerFactory.getLogger(ImagingQualityView.class);
	
	public ImagingQualityView() {
    ...
    private void openNotificationsPopup(final ClickEvent event) {
        ...
        List<Map<String, Object>> allMessages = ui.messagingService.findAllMessagesByUser(loggedInUser, DashboardViewType.IMAGING_QUALITY.getViewName());
