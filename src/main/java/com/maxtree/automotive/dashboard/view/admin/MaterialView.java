 ...
 *
 */
public class MaterialView extends ContentView {
	...
	public MaterialView(String parentTitle, AdminMainView rootView) {
		...
		GridColumn[] columns = {new GridColumn("材料名称",285), new GridColumn("编码",285),new GridColumn("", 20)}; 
		List<CustomGridRow> data = new ArrayList<>();
		List<DataDictionary> list = ui.dataItemService.findAllByType(DataDictionaryType.MATERIAL);
