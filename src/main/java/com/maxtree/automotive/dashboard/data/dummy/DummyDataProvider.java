package com.maxtree.automotive.dashboard.data.dummy;

import com.maxtree.automotive.dashboard.data.DataProvider;
...
//    private static Multimap<Long, Tran> transactions;
...
//     * @return
//     */
//    private Multimap<Long, Tran> generateTransactionsData() {
//        Multimap<Long, Tran> result = MultimapBuilder.hashKeys()
//                .arrayListValues().build();
//
//        for (Movie movie : movies) {
//            result.putAll(movie.getId(), new ArrayList<Tran>());
//
//            Calendar cal = Calendar.getInstance();
...
//
//    @Override
//    public Collection<Tran> getRecentTransactions(int count) {
//        List<Tran> orderedTransactions = Lists.newArrayList(transactions
//                .values());
//        Collections.sort(orderedTransactions, new Comparator<Tran>() {
//            @Override
...
//        for (Tran transaction : transactions.get(movie.getId())) {
...
//        double result = 0;
//        for (Tran transaction : transactions.values()) {
...
//
//    @Override
//    public Collection<Tran> getTransactionsBetween(final Date startDate,
//            final Date endDate) {
//        return Collections2.filter(transactions.values(),
//                new Predicate<Tran>() {
//                    @Override
//                    public boolean apply(Tran input) {
