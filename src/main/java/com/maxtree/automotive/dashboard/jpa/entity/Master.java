...
public class Master {
    ...
    /** 上次更新时间 */
    private String updateDateTime;// 避免读脏

    protected Master() {}

    public Master(String workId, String barcode, String plateType, String plateNumber, String vin, String business, String businessStatus, String placeOfDomicile, Long siteId, Long communityId, Long companyId, String owner) {
        this.workId = workId;
