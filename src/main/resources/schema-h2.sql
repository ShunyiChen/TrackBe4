...
DROP TABLE IF EXISTS DOCUMENTS_1_0;
DROP TABLE IF EXISTS DOCUMENTS_2_0;
DROP TABLE IF EXISTS TRANSACTION_0;
...
CREATE TABLE DATADICTIONARY (
	DICTIONARYUNIQUEID INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE USERBUSINESSES (
	UBUNIQUEID INT AUTO_INCREMENT PRIMARY KEY,
	USERUNIQUEID INT NOT NULL,
	BUSINESSUNIQUEID INT NOT NULL
);
...
CREATE TABLE SITEFOLDER (
	SITEFOLDERUNIQUEID INT AUTO_INCREMENT PRIMARY KEY,
	SITEUNIQUEID INT,
...
CREATE TABLE MESSAGERECIPIENT (
	MESSAGERECIPIENTUNIQUEID INT AUTO_INCREMENT PRIMARY KEY,
