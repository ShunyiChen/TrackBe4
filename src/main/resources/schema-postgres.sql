...
--获取模糊查询
DROP FUNCTION IF EXISTS CREATE_SEARCH(PAGE INT);
CREATE OR REPLACE FUNCTION CREATE_SEARCH(LIMIT2 INT) RETURNS SETOF INTEGER AS
$BODY$
DECLARE
  A INTEGER := 0;
  B INTEGER := 0;
...
SELECT * FROM CREATE_PAGINGCOUNT(20)$$