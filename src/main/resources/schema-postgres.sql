...
CREATE TABLE STOREHOUSE (
	...
	SERIALNUMBER INT NOT NULL, --库房顺序号（3位数）
...
CREATE TABLE DENSEFRAME (
	...
	MAXCOL INT NOT NULL,
	MAXROW INT NOT NULL,
	SERIALNUMBER INT NOT NULL,--密集架顺序号（3位数）
	STOREHOUSESN INT NOT NULL --库房顺序号（3位数）
);
--文件盒(单元格)
CREATE TABLE FILEBOX (
	...
	SERIALNUMBER INT NOT NULL,--单元格顺序号（3位数）
	DENSEFRAMESN INT NOT NULL,--密集架顺序号（3位数）
	STOREHOUSESN INT NOT NULL --库房顺序号（3位数）
);
--档案袋
CREATE TABLE PORTFOLIO (
	...
	CODE VARCHAR(20) NOT NULL,--上架号，例如014-002-003-001(密集架号-列-行-文件夹序号）
	FILEBOXSN INT NOT NULL,--单元格顺序号（3位数）
	DENSEFRAMESN INT NOT NULL,--密集架顺序号（3位数）
	STOREHOUSESN INT NOT NULL --库房顺序号（3位数）
);
