...
CREATE TABLE COMPANIES (
	...
	ADDRESS VARCHAR(60),
	CANCREATESTOREHOUSE INT NOT NULL, -- 1可以创建库房，0不可以创建库房
...
CREATE TABLE MESSAGERECIPIENT (
	...
	RECIPIENTTYPE INT NOT NULL, --接收方类别
...
CREATE TABLE REMINDERFREQUENCY (
	...
	NAME VARCHAR(20),
	FREQUENCY INT NOT NULL, -- 1-每天 7-每周
	ACTIVE INT NOT NULL,--0未激活 1已激活
	STARTINGTIME TIMESTAMP,--起始时间
	ENDINGTIME TIMESTAMP, -- 结束时间
	NEXTREMINDERTIME TIMESTAMP -- 下次提醒时间
);
--发送细节
CREATE TABLE SENDDETAILS(
	...
	MESSAGEUNIQUEID INT NOT NULL, -- 消息ID
	MARKEDASREAD INT NOT NULL, -- 标记已读
