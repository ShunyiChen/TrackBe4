...
CREATE TABLE STOREHOUSE (
	...
	CODE VARCHAR(36) NOT NULL, --UUID,库房CODE
...
CREATE TABLE DENSEFRAME (
	...
	CODE VARCHAR(36) NOT NULL, --UUID,密集架CODE
	STOREHOUSECODE VARCHAR(36) NOT NULL --UUID,库房CODE
);
--文件盒(单元格)
CREATE TABLE FILEBOX (
	...
	CODE VARCHAR(36) NOT NULL, --UUID,单元格CODE
	DENSEFRAMECODE VARCHAR(36) NOT NULL--密集架CODE
);
--档案袋
CREATE TABLE PORTFOLIO (
	...
	VIN VARCHAR(50),
	SERIALNUMBER INT NOT NULL,
	FILEBOXCODE VARCHAR(36) NOT NULL --UUID,单元格CODE
);
--租户
