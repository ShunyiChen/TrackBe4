...
BEGIN 
   ...
   FOR i IN 0..255 LOOP
	...
	SITEUNIQUEID INT NOT NULL,--站点ID
 ...
 CREATE TABLE FINALCHECK (
	CHECKUNIQUEID SERIAL PRIMARY KEY,
	BARCODE VARCHAR(50),--条形码
	VIN VARCHAR(50) NOT NULL--车辆识别代码
);
...
CREATE TABLE SERVERUSER (
	SERVERUSERUNIQUEID SERIAL PRIMARY KEY,
	USERNAME VARCHAR(60) NOT NULL,--用户名
	USERPASSWORD VARCHAR(60) NOT NULL,--用户密码
	ENABLEFLAG BOOLEAN,--是否启用
	WRITEPERMISSION BOOLEAN, --有写的权限
	MAXLOGINNUMBER INT,--最大登录数
	MAXLOGINPERIP INT,--每个IP最多登录数
	IDLETIME INT, --停歇时间
	UPLOADRATE INT,--上传速率
	DOWNLOADRATE INT,--下载速率
	SERVERCODE VARCHAR(7)--服务器编码
);
