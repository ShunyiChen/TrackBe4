...
DROP TABLE IF EXISTS BUSINESSITEMS2;
...
DROP TABLE IF EXISTS IMAGING;
DROP TABLE IF EXISTS SYSTEMSETTINGS;--系统设置
DROP TABLE IF EXISTS FEEDBACK;--批改建议 
...
DROP TABLE IF EXISTS CARS;--车辆信息表
DROP TABLE IF EXISTS TENANT;--租户表
DROP TABLE IF EXISTS LOCATIONS;--地址表
...
--	INSERT INTO ROLERIGHT(ROLEUNIQUEID, PERMISSIONUNIQUEID) VALUES(1,76);
 ...
 --   INSERT INTO SITEFOLDER(SITEUNIQUEID, BATCHCOUNT, BUSINESSCOUNT) VALUES (1, 1, 0);
    ...
    INSERT INTO SYSTEMSETTINGS(NAME,VALUE,COMMENTS) VALUES('UI事件轮询间隔（毫秒）:','2000','');
    INSERT INTO SYSTEMSETTINGS(NAME,VALUE,COMMENTS) VALUES('缓存最大条目数:','10000','');
    INSERT INTO SYSTEMSETTINGS(NAME,VALUE,COMMENTS) VALUES('缓存条目有效期（分钟）:','5','');
    INSERT INTO SYSTEMSETTINGS(NAME,VALUE,COMMENTS) VALUES('缓存条目刷新间隔（分钟）:','1','');
